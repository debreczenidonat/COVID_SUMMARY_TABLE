 ...
 reactable(
  ...
  columns = list(
    ...
    New_case_count_per_mill_smoothed = colDef(
      header = "Latest smoothed new case count/M Pop"
      ,filterable=F
    ),
    ...
    New_cases_timeline = colDef(
      ...
      header="Smoothed new cases last 7 days"
      ,filterable=F
      ,width=90
      ,align = "center"
    ),
    ...
    New_death_count_per_mill_smoothed = colDef(
      header = "Latest smoothed new death count/M Pop"
      ,filterable=F
      ,width=90
    ),
    ...
    New_deaths_timeline = colDef(
      ...
      header="Smoothed new deaths last 7 days"
      ,filterable=F
      ,width=90
      ,align = "center"
    )
